...
function TripSchedules() {
  ...
  const loadTripSchedules = async () => {
    try {
      const tripSchedules = await axios.get("http://localhost:8082/train/trip-schedule/getAll", {
        mode: "no-cors",
        headers: {
  ...
  const updateTripSchedule = async (tripSchedule) => {
    ...
    const updatedTripSchedule = axios.put("http://localhost:8082/train/trip-schedule/update/"+tripScheduleForEdit.id,tripSchedule,{
      mode: "no-cors",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
  ...
  const addTripSchedule = (trip) => {
    ...
    const newTripSchedule = axios.post("http://localhost:8082/train/trip-schedule/add",trip,{
      mode: "no-cors",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
  ...
  const deleteTripSchedule = (tripSchedule) => {
    ...
    if(window.confirm("Do you really want to delete")){
      ...
      const deletedTripSchedule = axios.delete("http://localhost:8082/train/trip-schedule/delete/"+tripSchedule.id,{
        mode: "no-cors",
        headers: {
          "Access-Control-Allow-Origin": "*",
          "Content-Type": "application/json",
  ...
  return (
    <div style={{marginTop:'4%', width:'100%'}}>
      <PageHeader
        ...
        subTitle="List of available Route schedules in the database"
