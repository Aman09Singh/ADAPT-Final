...
function Users() {
  ...
  const loadUsers = async () => {
    try {
      const users = await axios.get("http://localhost:8081/user/getAll", {
        mode: "no-cors",
        headers: {
  ...
  const updateUser = async (user) => {
    ...
    const updatedUser = axios.put("http://localhost:8081/user/update/"+userForEdit.id,user,{
      mode: "no-cors",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
  ...
  const addUser = (user) => {
    ...
    const newUser = axios.post("http://localhost:8081/user/add",user,{
      mode: "no-cors",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
  ...
  const deleteUser = (user) => {
    ...
    const deletedUser = axios.delete("http://localhost:8081/user/delete/"+user.id,{
      mode: "no-cors",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
